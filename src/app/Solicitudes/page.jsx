...
import TablaAcciones from "@/Components/carro/TablaAcciones";
        ...
        async function fetchData() {
            try {
                ...
                const consulta = `SELECT 
                                ...
                                JOIN USUARIO u ON r.CodigoUsuarioSolicita = u.CodigoUsuario
                                JOIN ImagenCarro i ON c.CodigoCarro = i.CodigoCarro
                                where c.Propietario = ${sesion.CodigoUsuario}
